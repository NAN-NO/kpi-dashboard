    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white dark:bg-slate-900 rounded-xl shadow-lg p-8 border border-slate-200 dark:border-slate-800">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-slate-800 dark:text-white">ระบบฐานข้อมูลตัวชี้วัด</h2>
          <p className="text-slate-500 dark:text-slate-400 mt-2">Clinic Governance (CG KPI Dashboard)</p>
        </div>
